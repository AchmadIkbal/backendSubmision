...
const addBook = (request, h) => {
    ...
    if (!name) {
        // User tidak mengisi properti name pada request body
        const response = h
            .response({
                status: 'fail',
    ...
    if (readPage > pageCount) {
        // User mengisi nilai properti readPage yang lebih besar dari nilai properti pageCount
        const response = h
            .response({
                status: 'fail',
...
const getBookById = (request, h) => {
    ...
    if (book) {
        // Buku yang di lampirkan sesuai id
        const response = h
            .response({
                status: 'success',
                data: {
    ...
    // Bila buku dengan id yang di input tidak sama
    const response = h
        .response({
            status: 'fail',
...
const deleteBookById = (request, h) => {
    ...
    if (index !== -1) {
        ...
        // Bila id dimiliki pada data buku
        const response = h
            .response({
                status: 'success',
    ...
    // Bila id yang dilampirkan tidak tersedia
    const response = h
        .response({
            status: 'fail',
